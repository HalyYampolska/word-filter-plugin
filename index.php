...
class OurWordFilterPlugin {
    ...
    function ourSettings() {
        ...
        add_settings_field('replacement-text', 'Filtered Text', array($this, 'replacementFieldHTML'), 
    ...
    function ourMenu() {
        ...
        add_submenu_page('ourwordfilter','Words To Filter','Word List','manage_options',
        'ourwordfilter', array($this, 'wordFilterPage'));
        add_submenu_page('ourwordfilter','Word Filter Options','Options','manage_options',
        'word-filter-options', array($this, 'optionsSubPage'));
